...
function get_product($con, $limit = '', $cat_id = '', $product_id = '', $search_str = '', $sort_order = '', $is_best_seller = '', $sub_category = '')
{
...
function sentInvoice($con, $order_id)
{
	...
	$user_order = mysqli_fetch_assoc(mysqli_query($con, "select `order`.*, user.name,user.email  from `order`,user where user.id=`order`.user_id and `order`.id='$order_id'"));
					...
					<table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
					  <tr>
						<td class="content-cell" align="center">
						  <p class="f-fallback sub align-center">&copy; 2022 [Kawshik Roy]. All rights reserved.</p>
	...
	$mail->SMTPSecure = "tls";
	$mail->SMTPAuth = true;
	$mail->Username = "pharmacyalliance79@gmail.com";
	$mail->Password = "ijjnwghfvoavytyf";
	$mail->SetFrom("pharmacyalliance79@gmail.com");
